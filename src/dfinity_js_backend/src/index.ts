...
//REGISTER A NEW USER TO THE SYSTEM
    ...
    //REGSITER A NEW BUSINESS TO THE SYSTEM
    //     addBusiness: update([BusinessPaylod], Result(Business, Message), (businesspayload) => {
    //     if (typeof businesspayload !== "object" || Object.keys(businesspayload).length === 0) {
    //         return Err({ NotFound: "invalid payoad" })
    //     }
